...
const Faq = () => {
    return (
        <div >
            <Accordion className='w-50 mx-auto my-5 p-5 bg-danger' defaultActiveKey="0">
      <Accordion.Item className='mb-3 fs-4' eventKey="0">
      ...
      <Accordion.Item  className='mb-3 fs-4'eventKey="1">
      ...
      <Accordion.Item className='mb-3 fs-4'eventKey="2">
      ...
      <Accordion.Item className='mb-3 fs-4' eventKey="3">
